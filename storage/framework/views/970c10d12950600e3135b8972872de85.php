...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2 style="color: #333; margin-bottom: 20px;">Hi <?php echo e($user->name); ?>,</h2>
            ...
            <p style="font-size: 14px; color: #666;">
                ...
                <br>
                <a href="<?php echo e($verificationUrl); ?>" style="color: #667eea; word-break: break-all;"><?php echo e($verificationUrl); ?></a>
            </p>
        </div>
        
        <div class="footer">
            <p style="margin: 0; color: #666; font-size: 14px;">
                <strong><?php echo e(config('app.name')); ?></strong> - Connecting communities, reuniting belongings
            </p>
...
</html><?php /**PATH E:\Final_Project\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>