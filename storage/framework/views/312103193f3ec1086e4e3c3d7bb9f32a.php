            ...
            <div class="mx-auto max-w-7xl">
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="<?php echo e(route('posts.index')); ?>" class="inline-flex items-center justify-center rounded-xl bg-white px-6 py-3 text-base font-semibold text-gray-900 shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                        ...
                        <a href="<?php echo e(route('ai-search.index')); ?>" class="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-purple-600 hover:to-pink-600 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('posts.create')); ?>" class="inline-flex items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/30 px-6 py-3 text-base font-semibold text-white hover:bg-white/20 hover:ring-white/50 transition-all duration-200 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/30 px-6 py-3 text-base font-semibold text-white hover:bg-white/20 hover:ring-white/50 transition-all duration-200 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
                            </svg>
                            Sign In
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <dl class="mt-12 grid grid-cols-3 gap-4 sm:grid-cols-3 text-left">
                        <div class="flex flex-col rounded-xl bg-white/10 p-4 ring-1 ring-white/20">
                            ...
                            <dd class="mt-1 text-2xl font-bold text-white"><?php echo e(number_format($activeListings)); ?></dd>
                        </div>
                        <div class="flex flex-col rounded-xl bg-white/10 p-4 ring-1 ring-white/20">
                            <dt class="text-sm text-indigo-100">Items reunited</dt>
                            <dd class="mt-1 text-2xl font-bold text-white"><?php echo e(number_format($resolvedItems)); ?></dd>
                        </div>
                        <div class="flex flex-col rounded-xl bg-white/10 p-4 ring-1 ring-white/20">
                            <dt class="text-sm text-indigo-100">Registered users</dt>
                            <dd class="mt-1 text-2xl font-bold text-white"><?php echo e(number_format($registeredUsers)); ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mx-auto mt-12 grid max-w-6xl grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="pt-4">
                            <a href="<?php echo e(route('ai-search.index')); ?>" class="inline-flex items-center rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-purple-700 hover:to-pink-700 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.091 3.091ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423Z"></path>
                                </svg>
                                Try AI Search Now
                    ...
                    <?php else: ?>
                        <div class="pt-4">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-purple-700 hover:to-pink-700 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                                </svg>
                                Get Started Free
            ...
            <div class="mt-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                        <div class="text-2xl"><?php echo e($icons[$category] ?? '📦'); ?></div>
                        <div class="mt-3 font-medium text-gray-900"><?php echo e(ucfirst($category)); ?></div>
                    </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
                    ...
                    <p class="mt-3 text-gray-600">See how people like you used <?php echo e(config('app.name')); ?> to reunite items with their owners.</p>
                    <a href="<?php echo e(route('success-stories.index')); ?>" class="mt-6 inline-flex items-center rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php $__empty_1 = true; $__currentLoopData = $latestFeedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="rounded-2xl border border-gray-100 bg-gray-50 p-6">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500"><?php echo e($item->created_at->diffForHumans()); ?></p>
                                    </div>
                                    <?php if(!is_null($item->rating)): ?>
                                        <div class="text-yellow-500 text-sm" aria-label="Rating: <?php echo e($item->rating); ?> out of 5">
                                            <?php for($i=1;$i<=5;$i++): ?>
                                ...
                                <p class="mt-3 text-gray-700"><?php echo e(Str::limit($item->message, 220)); ?></p>
                            </div>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('feedback.index')); ?>" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-800">Read all feedback →</a>
                    </div>
                </div>
                <div>
    ...
    <footer class="bg-white border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <div class="text-xl font-bold text-gray-900"><?php echo e(config('app.name')); ?></div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-gray-600 hover:text-gray-900">Home</a></li>
                        <li><a href="<?php echo e(route('posts.index')); ?>" class="text-gray-600 hover:text-gray-900">Browse Items</a></li>
                        <li><a href="<?php echo e(route('success-stories.index')); ?>" class="text-gray-600 hover:text-gray-900">Success Stories</a></li>
                        <li><a href="<?php echo e(route('feedback.index')); ?>" class="text-gray-600 hover:text-gray-900">Feedback</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm">
                        <?php if(auth()->guard()->check()): ?>
                            <li><a href="<?php echo e(route('dashboard')); ?>" class="text-gray-600 hover:text-gray-900">Dashboard</a></li>
                            <li><a href="<?php echo e(route('posts.create')); ?>" class="text-gray-600 hover:text-gray-900">Post Item</a></li>
                            <li><a href="<?php echo e(route('posts.my-posts')); ?>" class="text-gray-600 hover:text-gray-900">My Posts</a></li>
                            <li><a href="<?php echo e(route('messages.index')); ?>" class="text-gray-600 hover:text-gray-900">Messages</a></li>
                        <?php else: ?>
                            <li><a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-gray-900">Login</a></li>
                            <li><a href="<?php echo e(route('register')); ?>" class="text-gray-600 hover:text-gray-900">Register</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div>
                    ...
                    <a href="<?php echo e(route('feedback.index')); ?>" class="mt-3 inline-flex items-center rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-lg hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
                <p class="text-sm text-gray-500">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved, Developed by Sayed-2147, Sakib-2107, Miraj-2106 | Department of CSE, Premier University Chattogram.
</p>
            </div>
        </div>
    </footer>
...
<?php endif; ?>
<?php /**PATH E:\Final_Project\resources\views/landing.blade.php ENDPATH**/ ?>