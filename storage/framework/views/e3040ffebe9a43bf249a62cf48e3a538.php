...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('AI Search Results')); ?>
            ...
            <div class="max-w-7xl mx-auto">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4 text-sm text-gray-600">
                                <span class="flex items-center">
                                    ...
                                    <?php echo e($totalFound); ?> <?php echo e(Str::plural('match', $totalFound)); ?> found
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                    </svg>
                                    <?php echo e(round($threshold * 100)); ?>% similarity threshold
                                </span>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                            <a href="<?php echo e(route('ai-search.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-colors">
                ...
                <?php if(isset($searchFilters) && (
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(!empty($searchFilters['category'])): ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                    </svg>
                                    Category: <?php echo e(ucfirst($searchFilters['category'])); ?>

                                </span>
                            <?php endif; ?>
                            <?php if(!empty($searchFilters['location'])): ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                                    Location: <?php echo e($searchFilters['location']); ?>

                                </span>
                            <?php endif; ?>
                            <?php if(!empty($searchFilters['date_from'])): ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">
                                    ...
                                    From: <?php echo e(\Carbon\Carbon::parse($searchFilters['date_from'])->format('M d, Y')); ?>

                                </span>
                            <?php endif; ?>
                            <?php if(!empty($searchFilters['date_to'])): ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a4 4 0 118 0v4m-4 8a4 4 0 11-8 0v-3a5 5 0 0110-4.9M15 8a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                                    To: <?php echo e(\Carbon\Carbon::parse($searchFilters['date_to'])->format('M d, Y')); ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <img src="<?php echo e(Storage::url($searchImagePath)); ?>" alt="Search Image" class="max-w-sm max-h-64 rounded-xl shadow-lg border border-gray-200">
                ...
                <?php if($similarPosts->count() > 0): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        <?php $__currentLoopData = $similarPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $post = $item['post'];
                            ...
                            <div class="result-card bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
                                ...
                                <div class="relative h-48 overflow-hidden">
                                    <?php if($post->images): ?>
                                        <img src="<?php echo e(Storage::url($post->images)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                    ...
                                    <div class="absolute top-3 left-3">
                                        <span class="px-2 py-1 rounded-full text-xs font-medium shadow-lg <?php echo e($post->type === 'lost' ? 'bg-red-100 text-red-800 border border-red-200' : 'bg-green-100 text-green-800 border border-green-200'); ?>">
                                            <?php echo e($post->type === 'lost' ? '🔍 Lost' : '✅ Found'); ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        <h3 class="text-lg font-semibold text-gray-900 line-clamp-2 flex-1"><?php echo e($post->title); ?></h3>
                                    ...
                                    <!-- Description -->
                                    <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($post->description, 100)); ?></p>
                                    ...
                                    <div class="space-y-2 text-sm text-gray-500 mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <span class="truncate"><?php echo e($post->location); ?></span>
                                        </div>
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('posts.show', $post)); ?>" class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-center py-2 px-4 rounded-lg text-sm font-medium transition-all duration-200 transform hover:scale-105">
                                            View Details
                                        </a>
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if($post->user_id !== auth()->id()): ?>
                                                <a href="<?php echo e(route('messages.create', $post)); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg text-sm font-medium transition-colors">
                                                    Contact
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-600 mb-6">
                                We couldn't find any posts similar to your image with the current similarity threshold (<?php echo e(round($threshold * 100)); ?>%).
                            </p>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                                <a href="<?php echo e(route('ai-search.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                    </svg>
                                    Try Another Search
                                </a>
                                <a href="<?php echo e(route('posts.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-colors">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function cleanupSearchImages() {
                fetch('<?php echo e(route("ai-search.cleanup")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php endif; ?><?php /**PATH E:\Final_Project\resources\views/ai-search/results.blade.php ENDPATH**/ ?>