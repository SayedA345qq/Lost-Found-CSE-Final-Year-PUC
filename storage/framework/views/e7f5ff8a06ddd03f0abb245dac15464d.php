        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 mt-1">
                    ...
                    Click the link in the email to verify your account and start using <?php echo e(config('app.name')); ?>.
                </p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH E:\Final_Project\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>