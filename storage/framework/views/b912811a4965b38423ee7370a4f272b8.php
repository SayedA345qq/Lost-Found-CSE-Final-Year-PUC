        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-md p-8 mb-8">
                    <form action="<?php echo e(route('ai-search.search')); ?>" method="POST" enctype="multipart/form-data" id="searchForm">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH E:\Final_Project\resources\views/ai-search/index.blade.php ENDPATH**/ ?>