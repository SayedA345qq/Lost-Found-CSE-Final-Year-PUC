<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <p class="text-sm text-gray-600 mb-4">Tell us what you think about <?php echo e(config('app.name')); ?>.</p>

        

        <?php if(auth()->guard()->check()): ?>
            <form method="POST" action="<?php echo e(route('feedback.store')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php endif; ?>
                    <select id="rating" name="rating" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <?php for($i=5;$i>=1;$i--): ?>
                            <option value="<?php echo e($i); ?>" <?php if(old('rating')==$i): echo 'selected'; endif; ?>><?php echo e($i); ?> Star<?php echo e($i>1?'s':''); ?></option>
                        <?php endfor; ?>
                    </select>
...
<?php unset($__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581); ?>
<?php endif; ?>
                    <textarea id="message" name="message" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required><?php echo e(old('message')); ?></textarea>
                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>Submit Feedback <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH E:\Final_Project\resources\views/feedback/partials/form.blade.php ENDPATH**/ ?>