        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                    <form method="GET" action="<?php echo e(route('posts.index')); ?>" class="flex gap-2">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('ai-search.index')); ?>" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-md whitespace-nowrap flex items-center gap-2 transition-colors duration-200">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('posts.create')); ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="filterPanel" class="hidden border-t border-gray-200 pt-4">
                <form method="GET" action="<?php echo e(route('posts.index')); ?>" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <!-- Location Filter -->
                        <div class="relative">
                            <input type="text" name="location" id="location" value="<?php echo e(request('location')); ?>" 
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="<?php echo e(route('posts.index')); ?>" class="bg-gray-500 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-md transition-colors">
                                Clear All
                            </a>
                        </div>
                    </div>
                ...
                <?php if(request()->hasAny(['type', 'category', 'location', 'date_from', 'date_to', 'sort'])): ?>
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <?php if(request('type')): ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    ...
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['type' => null])); ?>" class="ml-1 text-blue-600 hover:text-blue-800">×</a>
                                </span>
                            <?php endif; ?>
                            ...
                            <?php if(request('category')): ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                    ...
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['category' => null])); ?>" class="ml-1 text-green-600 hover:text-green-800">×</a>
                                </span>
                            <?php endif; ?>
                            ...
                            <?php if(request('location')): ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                    ...
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['location' => null])); ?>" class="ml-1 text-purple-600 hover:text-purple-800">×</a>
                                </span>
                            <?php endif; ?>
                            ...
                            <?php if(request('date_from') || request('date_to')): ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                    Date Range
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => null, 'date_to' => null])); ?>" class="ml-1 text-yellow-600 hover:text-yellow-800">×</a>
                                </span>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-md hover:shadow-lg sm:rounded-lg transition-shadow duration-200 border border-gray-100">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-start mb-4">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                               <?php echo e($post->status === 'resolved' ? 'bg-blue-100 text-blue-800' : 
                                ...
                                <p class="text-gray-600 text-sm mb-3"><?php echo e(Str::limit($post->description, 100)); ?></p>
                                ...
                                <div class="text-sm text-gray-500 space-y-1 mb-4">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <?php echo e($post->date_lost_found->format('M d, Y')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => $post->user,'size' => 'xs','class' => 'mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->user),'size' => 'xs','class' => 'mr-2']); ?>
...
<?php endif; ?><?php /**PATH E:\Final_Project\resources\views/posts/index.blade.php ENDPATH**/ ?>