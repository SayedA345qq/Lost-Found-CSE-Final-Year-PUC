                                            ...
                                            <div class="mt-4">
                                                <label for="images" class="cursor-pointer">
                                                    <span class="mt-2 block text-sm font-medium text-gray-900">
                                                        <?php echo e($post->images ? 'Click to replace image' : 'Click to upload image'); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <label class="flex items-center p-3 border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                                                <input type="radio" name="type" value="lost" <?php echo e(old('type', $post->type) === 'lost' ? 'checked' : ''); ?> required
                                                       class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                <span class="ml-3 text-sm text-gray-700">🔍 Lost Item</span>
                                            </label>
                                            <label class="flex items-center p-3 border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                                                <input type="radio" name="type" value="found" <?php echo e(old('type', $post->type) === 'found' ? 'checked' : ''); ?> required
                                                       class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $post->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="date_lost_found" id="date_lost_found" value="<?php echo e(old('date_lost_found', $post->date_lost_found->format('Y-m-d'))); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" required
                                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="active" <?php echo e(old('status', $post->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                                        <option value="resolved" <?php echo e(old('status', $post->status) === 'resolved' ? 'selected' : ''); ?>>Resolved</option>
                                    </select>
...
<?php endif; ?><?php /**PATH E:\Final_Project\resources\views/posts/edit.blade.php ENDPATH**/ ?>