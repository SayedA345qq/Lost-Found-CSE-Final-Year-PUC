<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__("Update your account's profile information and profile picture.")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'profile_image','value' => __('Profile Picture')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'profile_image','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Profile Picture'))]); ?>
            ...
            <div class="flex items-center space-x-6">
                <div class="shrink-0">
                    <img id="profile-preview" class="h-20 w-20 object-cover rounded-full border-2 border-gray-300" 
                         src="<?php echo e($user->getProfileImageUrl()); ?>" alt="Current profile photo">
                </div>
                <div class="flex-1">
                    <div class="flex items-center space-x-4">
                        ...
                        <?php if($user->profile_image): ?>
                            <form method="post" action="<?php echo e(route('profile.remove-image')); ?>" class="inline">
                                <?php echo csrf_field(); ?>
